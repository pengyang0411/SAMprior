...
is superior or inferior to a standard control after the trial has been 
...
$C$, we can compute the posterior distribution based on the observed 
trial data. This can be accomplished using the **`postmix`** function 
...
Peng Yang ([pyang7@mdanderson.org](mailto:pyang7@mdanderson.org))
